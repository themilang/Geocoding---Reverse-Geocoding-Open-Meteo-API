...
import {  TiWeatherShower, TiWeatherWindyCloudy, TiWeatherCloudy } from "react-icons/ti";

const WeatherCard = ({ loading, error, city, status, weatherIcon, temperature, wind, rain, cloudcover, currentDay, nextDays, nextDaysMaxTemp, nextDaysMinTemp }) => {
